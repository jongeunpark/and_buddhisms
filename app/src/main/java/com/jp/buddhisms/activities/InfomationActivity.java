...
public class InfomationActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    private void initView() {
        mScrollView = (ObservableScrollView) findViewById(R.id.infomation_scroll);
        mFlexibleSpaceView = findViewById(R.id.infomation_flexible_space);
        mTitleView = (TextView) findViewById(R.id.infomation_text_title);
        mTitleView.setText("불교의식");
        setTitle(null);
    ...
    private void initEvent() {
        ...
        findViewById(R.id.infomation_body).setPadding(0, flexibleSpaceAndToolbarHeight, 0, 0);
